# Generated by Powerlevel10k configuration wizard on 2022-01-06 at 15:05 CST.
...
() {
  ...
  #
    typeset -g POWERLEVEL9K_WIFI_CONTENT_EXPANSION='%F{${my_wifi_fg[P9K_WIFI_BARS+1]}}$P9K_WIFI_LAST_TX_RATE Mbps ${P9K_WIFI_SSID} ${P9K_WIFI_RSSI}'
